              ...
              <AnimatePresence>
                {showNotifications && (
                  <motion.div
                    ...
                    className={`absolute right-0 mt-2 w-80 border rounded-lg shadow-xl overflow-hidden z-50 ${
              ...
              <DropdownMenuTrigger asChild>
                <motion.div
                  ...
                  className={`flex items-center gap-3 px-3 py-2 rounded-lg cursor-pointer transition-all ${
                    isDark ? 'bg-[#0F172A] hover:bg-[#0F172A]/80' : 'bg-gray-100 hover:bg-gray-200'
                  }`}
                >
                  <motion.div 
